export default {
  ...
  statusNotLoggedIn: 'A rawr thread will appear here when logged in.',
  ...
  globalHotkeys: `
    ...
    <li><kbd>7</kbd> or <kbd>c</kbd> to compose a new rawr</li>
  ...
  `,
  timelineHotkeys: `
    <li><kbd>j</kbd> or <kbd>↓</kbd> to activate the next rawr</li>
    <li><kbd>k</kbd> or <kbd>↑</kbd> to activate the previous rawr</li>
  ...
  unableToLoadStatuses: 'Unable to load recent rawrs: {error}',
  report: 'Report',
  noContent: '(No content)',
  noStatuses: 'No rawrs to report',
  // Status options
  ...
  bookmarkStatus: 'Bookmark rawr',
  unbookmarkStatus: 'Unbookmark rawr',
  deleteAndRedraft: 'Delete and redraft',
  reportStatus: 'Report rawr',
  shareStatus: 'Share rawr',
  copyLinkToStatus: 'Copy link to rawr',
  // Account profile
  ...
  underlineLinks: 'Underline links in rawrs and profiles',
  accessibility: 'Accessibility',
  reduceMotion: 'Reduce motion in UI animations',
  disableTappable: 'Disable tappable area on entire rawr',
  ...
  disableInfiniteScrollDescription: `When infinite scroll is disabled, new rawrs will not automatically appear at
  ...
  pinnedStatus: 'Pinned rawr',
  rebloggedYou: 'boosted your rawr',
  favoritedYou: 'favorited your rawr',
  ...
  accountRebloggedYou: '{account} boosted your rawr',
  accountFavoritedYou: '{account} favorited your rawr',
  accountEdited: '{account} edited their rawr',
  rebloggedByAccount: 'Boosted by {account}',
  contentWarningContent: 'Content warning: {spoiler}',
  hasMedia: 'has media',
  hasPoll: 'has poll',
  shortStatusLabel: '{privacy} rawr by {account}',
  // Privacy types
  public: 'Public',
  unlisted: 'Unlisted',
  ...
  // status thread page
  statusThreadPage: 'rawr thread page',
  status: 'rawr',
  // toast messages
  ...
  bookmarkedStatus: 'Bookmarked rawr',
  unbookmarkedStatus: 'Unbookmarked rawr',
  ...
  unableToPost: 'Unable to post rawr: {error}',
  statusDeleted: 'rawr deleted',
  unableToDelete: 'Unable to delete rawr: {error}',
  ...
  unpinnedStatus: 'Unpinned rawr',
  unableToPinStatus: 'Unable to pin rawr: {error}',
  unableToUnpinStatus: 'Unable to unpin rawr: {error}',
  ...
  youAreOffline: 'You seem to be offline. You can still read rawrs while offline.',
  // Snackbar UI
